...
namespace titandb {
    ...
    struct StreamEntryID {
        ...
        [[nodiscard]] std::string ToString() const { return turbo::StrCat(ms, "-", seq); }
    ...
    public:
        virtual turbo::Status GenerateID(const StreamEntryID &last_id, StreamEntryID *next_id) = 0;
    ...
    public:
        ...
        turbo::Status GenerateID(const StreamEntryID &last_id, StreamEntryID *next_id) override;
    ...
    turbo::ResultStatus<std::unique_ptr<NextStreamEntryIDGenerationStrategy>>
    ParseNextStreamEntryIDStrategy(const std::string_view &input);

    turbo::Status ParseRangeStart(const std::string_view &input, StreamEntryID *id);

//  Copyright (c) 2017-present The tedis Authors.  All rights reserved.
...
// void BenchSet() {
//   printf("====== Set ======\n");
//   tedis::TedisOptions options;
//   options.create_if_missing = true;
//   tedis::Tedis db;
//   tedis::Status s = db.Open(options, "./db");
...
static void BenchHGetall(benchmark::State &state) {
    ...
    std::vector<tedis::FieldValue> fvs_in;
    std::vector<tedis::FieldValue> fvs_out;
    ...
    std::map<tedis::DataType, tedis::Status> type_status;
